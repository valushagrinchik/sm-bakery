...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`CREATE TABLE IF NOT EXISTS public.stores_time_work
(
    ...
    CONSTRAINT stores_time_work_pkey PRIMARY KEY (id),
    CONSTRAINT stores_time_work_store_id_fkey FOREIGN KEY (store_id)
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`DROP TABLE IF EXISTS public.stores_time_work`);
  },
};
