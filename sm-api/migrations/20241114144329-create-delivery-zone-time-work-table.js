...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`CREATE TABLE IF NOT EXISTS public.delivery_zones_time_work
(
    ...
    CONSTRAINT delivery_zones_time_work_pkey PRIMARY KEY (id),
    CONSTRAINT delivery_zones_time_work_delivery_zone_id_fkey FOREIGN KEY (delivery_zone_id)
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`DROP TABLE IF EXISTS public.delivery_zones_time_work`);
  },
};
